...
> **Scope:** This file configures agents working on the [`dbc-tech/agent-skills`](https://github.com/dbc-tech/agent-skills) repository itself, not other projects. Don't copy it into another project or a global agent configuration; the reusable assets are the skills in `skills/`.
