...
- **AGENTS.md and CLAUDE.md (prefer AGENTS.md) / rules files** — Document project conventions so agents follow them
...
- [ ] Rules files (AGENTS.md and CLAUDE.md; prefer AGENTS.md) are current and accurate
