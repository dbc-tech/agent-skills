...
Treat `agent-skills/skills/` (or a cloned [dbc-tech/agent-skills](https://github.com/dbc-tech/agent-skills)) as **upstream** — sync into `.cursor/skills/`, do not edit only upstream and expect Cursor to see it.
...
- Upstream: [github.com/dbc-tech/agent-skills](https://github.com/dbc-tech/agent-skills)
