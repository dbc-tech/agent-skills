...
```bash
cmd skills add dbc-tech/agent-skills
```
...
```bash
cmd skills add dbc-tech/agent-skills -s spec-driven-development
```

**User scope** (installs into `~/.commandcode/skills/`, available in every project):

```bash
cmd skills add dbc-tech/agent-skills --global
```

**Other supported forms:**

```bash
cmd skills add dbc-tech/agent-skills@main            # a specific branch
cmd skills add dbc-tech/agent-skills/skills/interview-me   # a specific path in the repo
cmd skills add dbc-tech/agent-skills --force         # overwrite / update if already installed
```
