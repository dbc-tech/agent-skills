...
> **Scope:** This file configures agents working on the [`dbc-tech/agent-skills`](https://github.com/dbc-tech/agent-skills) repository itself. It is not meant to be copied into other projects or into a global agent configuration; the reusable assets are the skills in `skills/`, not this file.
