...
- [x] Task 10: Create `scripts/install-opencode.sh` + `scripts/install-opencode-test.sh`
...
- [x] Task 13: Sweep all `CLAUDE.md`-only references to "AGENTS.md and CLAUDE.md" with "prefer AGENTS.md"
