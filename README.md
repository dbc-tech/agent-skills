...
```bash
npx skills add dbc-tech/agent-skills            # install all 24 skills
npx skills add dbc-tech/agent-skills --list     # browse before installing
```

Or grab individual skills:

```bash
npx skills add dbc-tech/agent-skills --skill code-review-and-quality   # five-axis review before merge
npx skills add dbc-tech/agent-skills --skill interview-me              # requirements interrogation, one question at a time
npx skills add dbc-tech/agent-skills --skill test-driven-development   # red-green-refactor, enforced
```
...
> tracked in [#361](https://github.com/dbc-tech/agent-skills/issues/361).
...
```
/plugin marketplace add dbc-tech/agent-skills
...
> ```bash
> /plugin marketplace add https://github.com/dbc-tech/agent-skills.git
> /plugin install agent-skills@addy-agent-skills
> ```
>
...
```bash
agy plugin install https://github.com/dbc-tech/agent-skills.git
```
...
```bash
gemini skills install https://github.com/dbc-tech/agent-skills.git --path skills
```
...
```bash
codex plugin marketplace add dbc-tech/agent-skills
...
```bash
cmd skills add dbc-tech/agent-skills            # pick skills to install (project)
cmd skills add dbc-tech/agent-skills --global   # install for all projects (~/.commandcode/skills/)
cmd skills add dbc-tech/agent-skills -s spec-driven-development  # install a specific skill
```
